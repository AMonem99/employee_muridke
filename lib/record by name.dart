...
class AttendanceRecordByName extends StatefulWidget {
  const AttendanceRecordByName({Key key}) : super(key: key);

  @override
  State<AttendanceRecordByName> createState() => _AttendanceRecordByNameState();
}

class _AttendanceRecordByNameState extends State<AttendanceRecordByName> {
  ...
  void initState() {
    ...
    _refAR = FirebaseDatabase.instance.reference().child('Name');
    // ignore: deprecated_member_use
  }
